...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    */
		...
		<?php
			if( false === get_post_format() ){
                ...
                the_content( sprintf(
    				...
    				wp_kses( __( 'Lire la suite %s <span class="meta-nav">&rarr;</span>', 'preschool-and-kindergarten' ), array( 'span' => array( 'class' => array() ) ) ),
    ...
    <footer class="entry-footer">		
        <a href="<?php the_permalink(); ?>" class="btn-readmore"><?php  esc_html_e( 'Lire la suite', 'preschool-and-kindergarten' );?></a>
